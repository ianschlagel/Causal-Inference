...
* Uses original predictors but a fake treatment year to check for pre-trends [cite: 7]
synth cigsale lnincome(1972(1)1980) age(1970(1)1980) retprice(1970(1)1980) ///
      ...
      keep(Results/synth_placebo_1981, replace) [cite: 7]
...
preserve
    ...
    graph export "Results/Graph3.pdf", replace [cite: 8]
restore


* --- 2. In-Space Placebos (Permutation Tests) ---
* Using synth_runner to estimate p-values for the 38 control states [cite: 9]
synth_runner cigsale lnincome(1980(1)1988) beer(1984(1)1988) age(1980(1)1988) ///
             ...
             trunit(3) trperiod(1989) gen_vars [cite: 9]

* Graphing standardized p-values
pval_graphs
graph export "Results/Graph4.pdf", replace [cite: 9]

* Manual Placebo Plot (Standardized by Pre-MSPE) [cite: 10, 11]
